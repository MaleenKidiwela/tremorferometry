...
COORDS = {
    ...
    'B017': (46.9960, -123.5575), 'B001': (48.0431, -123.1314),
    'B005': (48.0596, -123.5034), 'B003': (48.0623, -124.1416),
    'B045': (40.4360, -124.0008), 'B932': (40.2825, -124.2245), 'B049': (40.2403, -123.8225),
    # B933 (40.0571,-123.9728) DROPPED — contaminant-dominated (2-4s cc 0.54); excluded from path map/tomo
}
